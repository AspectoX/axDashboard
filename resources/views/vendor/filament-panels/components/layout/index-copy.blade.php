...
<x-filament-panels::layout.base :livewire="$livewire">
    ...
    <div
        class="flex flex-row-reverse w-full min-h-screen ax-layout overflow-x-clip"
    >
        <div
            ...
            @endif
            @class([
                'ax-main-ctn w-screen flex-1 flex-col',
        ...
        >
            ...
            <main
                @class([
                    'ax-main mx-auto h-full w-full px-4 md:px-6 lg:px-8',
        ...
        @if (filament()->hasNavigation())
            <div
                ...
                class="fixed inset-0 z-30 transition duration-500 fi-sidebar-close-overlay lg:hidden"
            ></div>

            <x-filament-panels::sidebar
                :navigation="$navigation"
                class="ax-main-sidebar"
            />
                ...
                document.addEventListener('DOMContentLoaded', () => {
                    setTimeout(() => {
                        let activeSidebarItem = document.querySelector(
                            '.ax-main-sidebar .ax-sidebar-item.ax-active',
                        )
                        ...
                        if (
                            ...
                            activeSidebarItem = document.querySelector(
                                '.ax-main-sidebar .ax-sidebar-group.ax-active',
                            )
                        }
                        ...
                        const sidebarWrapper = document.querySelector(
                            '.ax-main-sidebar .ax-sidebar-nav',
                        )

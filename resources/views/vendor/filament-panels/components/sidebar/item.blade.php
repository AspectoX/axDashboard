...
<li
    {{
        $attributes->class([
            ...
            'ax-active ax-sidebar-item-active' => $active,
...
>
    <a
        ...
        @endif
        @class([
            'ax-sidebar-item-button relative flex items-center justify-center gap-x-3 rounded-lg px-2 py-2 outline-none transition duration-75',
    ...
    >
        ...
        @if ((blank($icon) && $grouped) || $subGrouped)
            <div
                ...
                @endif
                class="relative flex items-center justify-center w-6 h-6 ax-sidebar-item-grouped-border"
            >
                @if (! $first)
                    <div
        ...
        <span
            ...
            @endif
            @class([
                'ax-sidebar-item-label flex-1 truncate text-sm font-medium',
    ...
    @if (($active || $activeChildItems) && $childItems)
        <ul class="flex flex-col ax-sidebar-sub-group-items gap-y-1">

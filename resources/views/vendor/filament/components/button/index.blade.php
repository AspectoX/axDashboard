...
@php
    ...
    $buttonClasses = \Illuminate\Support\Arr::toCssClasses([
        ...[
            'fi-btn ax-btn-'. current(explode('-', Str::slug($slot))) .' relative grid-flow-col items-center justify-center font-semibold outline-none transition duration-75 focus-visible:ring-2',
